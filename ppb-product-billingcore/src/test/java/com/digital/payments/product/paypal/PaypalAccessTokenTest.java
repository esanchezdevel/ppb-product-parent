...
public class PaypalAccessTokenTest {
	...
	void testPaypalGetAccessToken() {
		...
		HttpClientResponse response = new HttpClientResponse(200, successBody);
		...
		assertAll(() -> {
			...
			assertEquals(successBody, accessTokenResponse, "Wrong access token value");			
		});
	}
}
